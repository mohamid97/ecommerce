...
class RoleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $models = ['user','points','industry','wishlist','order','cart','wishlist','productoption','zone','city','bundel','promotion' , 'option','page','des','specification','certificate','faq','brand','applicant','branch', 'mediaimage', 'mediavideo','metasetting','ourteam','setting','offer' ,'product','coupon' ,'service' ,'role' , 'client' , 'event', 'feedback','achivement', 'ourwork','blog' ,'permission' ,'post', 'service' , 'lang' , 'slider' ,'message' ,'category' , 'about' , 'contact' , 'location' , 'maincontact' , 'social'];
