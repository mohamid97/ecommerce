...
class ProductService extends BaseModelService
{
    ...
    public function update($id){
        ...
        $product = parent::update($id , $this->getBasicColumn(['product_image','breadcrumb', 'sku', 'barcode', 'sale_price', 'discount', 'discount_type','has_options' , 'order' , 'brand_id','category_id', 'moq']));
        $this->processTranslations($product, $this->data, ['title', 'slug' ,'des' , 'small_des' , 'meta_title' , 'meta_des', 'alt_image' , 'title_image']);
