...
class ProductService extends BaseModelService
{
    ...
    if(isset($this->data['discount']) && isset($this->data['discount_type'])){
        ...
        $product = parent::store($this->getBasicColumn(['product_image','breadcrumb', 'sku', 'barcode', 'sale_price', 'discount', 'discount_type', 'status','has_options' , 'order' , 'brand_id','category_id', 'moq', 'units']));
    ...
    public function update($id){
        ...
        $product = parent::update($id , $this->getBasicColumn(['product_image','breadcrumb', 'sku', 'barcode', 'sale_price', 'discount', 'discount_type','has_options' , 'order' , 'brand_id','category_id', 'moq', 'units']));
        $this->processTranslations($product, $this->data, ['title', 'slug' ,'des' , 'small_des' , 'meta_title' , 'meta_des', 'alt_image' , 'title_image']);
