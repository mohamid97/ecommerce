...
class ProductVariant extends Model implements TranslatableContract
{
    ...
    protected $fillable = ['product_id' , 'sku' , 'barcode' , 'price' , 'status' , 'stock' , 'cost_price' , 'discount_value' , 'discount_type' , 'length' , 'width' , 'height' , 'weight' , 'delivery_time' , 'max_time' , 'images'];
